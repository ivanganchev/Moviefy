//
//  SearchMoviesTableViewDataSourceTests.swift
//  UnitTests
//
...
class SearchMoviesTableViewDataSourceTests: XCTestCase {
    let dataSource = SearchMoviesTableViewDataSource()
    ...
    func testGetMovieNegativeIndex() throws {
        XCTAssertNil(self.dataSource.getMovie(at:-8))
    }
